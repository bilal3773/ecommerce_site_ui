...
Widget otherProductTile(BuildContext context, Product product) {
  return Container(
      width: 150.0,
      child: Card(
         child: InkWell(
...
Widget otherProductListing(BuildContext context) {
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) =>
                otherProductTile(context, productSnapshot.products[index])),
      ),
    );
  }));
}
