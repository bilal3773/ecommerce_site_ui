...
Widget hotDealsProductTile(BuildContext context,Product product) {
  return Container(
      width: 180.0,
      child: Card(
         child: InkWell(
...
Widget hotDealsProductListing(BuildContext context) {
    ...
    child: SizedBox(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) =>
              hotDealsProductTile(context,productSnapshot.products[index])),
    ),
  );
      }));
}
