...
Widget groceryProductTile(BuildContext context,Product product) {
  return Container(
      width: 180.0,
      child: Card(
         child: InkWell(
...
Widget groceryProductListing(BuildContext context) {
    ...
    child: SizedBox(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) =>
              groceryProductTile(context,productSnapshot.products[index])),
    ),
  );
      }));
}
