...
Widget mobileAccessoryProductTile(BuildContext context, Product product) {
  return Container(
      width: 180.0,
      child: Card(
          child: InkWell(
...
Widget mobileAccessoryProductListing(BuildContext context) {
      ...
      child: SizedBox(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) =>
                mobileAccessoryProductTile(
                    context, productSnapshot.products[index])),
      ),
    );
  }));
}
