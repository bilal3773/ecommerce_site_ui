...
Widget faceMasksProductTile(BuildContext context,Product product) {
  return Container(
      width: 180.0,
      child: Card(
         child: InkWell(
...
Widget faceMasksProductListing(BuildContext context) {
    ...
    child: SizedBox(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) =>
              faceMasksProductTile(context,productSnapshot.products[index])),
    ),
  );
      }));
}
